...
<!-- End Google Tag Manager -->
        ...
        <meta name="description" content="Somos VermiBA, todo sobre lombricultura, como se reproducen las lombrices, como criar, como alimentar, manuales y mas. Buscanos en las redes sociales!"> 
        <meta name="keywords" content="HTML,CSS,XML,JavaScript,vermicultura,vermicompostaje,lombriz,lombrices,lombriz roja californiana,como hacer, compost,eisenia foetida,humus, humus de lombriz">
...
<body>
  <div class="cuerpo">
        ...
        <div class="card-vermi p-4">
                ...
                <span class="text-muted">
                  ...
                  <h2 class="text-center parr">
                    Es una Biotecnología que aplica normas y técnicas de producción utilizando las <i class="text-white">lombrices rojas</i> californianas para reciclar <I class="text-white">residuos orgánicos biodegradables</I>. 
                  <br>
                  <small>Mira un video explicativo!</small> 
                </h2>
                  <div class="frame">
                    <iframe width="auto" height="315" src="https://www.youtube.com/embed/V8miLevRI_o" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     
                  <a href="https://www.youtube.com/watch?v=V8miLevRI_o" target="_blank" rel="noopener">Vermicompostaje TED</a>
                  </div>
    ...
    <section id="como"><!-- COMO -->
      <div class="alert-info p-4">
          <h1 class="text-dark">¿Como empiezo?</h1>
            <div class="row">
                <div class="col">        
                    <p class="text-center parr">
                      La vermicultura es una actividad <strong>sencilla, poco costosa</strong> y segura,  que puede ser realizada por niños o personas mayores.</p>
                      <p class="manual">
                      Solo necesitamos:
                      <ul class="listita">
                ...
                <div class="container col">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Click para ver</button>
                    <div id="demo" class="collapse">
                        ...
                        <p >
                          ...
                          <img src="img/cajon.webp" class="img-fluid imgWeb" alt="">
                            ...
                            <hr>
                            Humedecemos lo suficiente como para mojar todo, pero no para que quede mucho liquido en el fondo, lo cubrimos con una remera vieja o con la misma bolsa 
                            y lo dejamos 48 hs.
                            ...
                            <hr>
                            Y ahora listo! Ahora a esperar. <br> Una vez que no se pueda identificar el material que pusimos es hora de volver a agregar material marrón y materia organica. 

                            <hr>
                            <p>
                                Para mas info, visita nuestra <a href="#mercado" title="Tienda">tiendita</a> o dejanos una <a href="#consulta" title="Consulta">consulta.</a> abajo! 
                                </p>  
...
<!-- SCRIPTS -->
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KZ3R7XP"
